...
void Implementation(){
  ...
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.01minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.02minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.03minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.04minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.05minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.06minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.07minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.08minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.09minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_2depth_0.10minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.01minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.02minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.03minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.04minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.05minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.06minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.07minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.08minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.09minnode_0.07lr");
  mvaNames.push_back("BDT_scan_1000ntree_3depth_0.10minnode_0.07lr");
...
//  std::string dir    = "/unix/atlas3/abell/VHbb_MVATrain/train_v2/weights/";
  ...
  "/unix/atlas3/abell/VHbb_MVATrain/Implementation/Results_v3/background_Normal.root" ;
  myT_Signal=new TChain("Nominal");
  "/unix/atlas3/abell/VHbb_MVATrain/Implementation/Results_v3/Direct_Signal.root" ;
