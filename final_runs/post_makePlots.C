...
void makePlots() {
  ...
  config.setInputFile("output_final");
  ...
  */ 
  ...
  config.addVariable(Config::BDTInput, "mBB", "m_{bb} [GeV]", 0, 500, 10);
  ...
  config.addVariable(Config::BDTInput, "pTJ3", "p_{T}(b_{3}) [MeV]", 0, 250000, 4);
  config.addVariable(Config::BDTInput, "mBBJ", "m(bbj) [MeV]", 0, 500000, 4);
  ...
  config.addVariable(Config::BDTOutput, "mvajamesv3", "BDT signal", -1, 1, 40);
  ...
  */
  ...
  // }
   ...
   config.addSensitivityPlot( "mvajamesv3", "mvajamesv3", "2tag2jet_150ptv_SR", "trafoD");
