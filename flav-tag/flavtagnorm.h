...
#ifndef flavtagnorm_h
#define flavtagnorm_h
...
class flavtagnorm : public TSelector {
public :
   ...
   ClassDef(flavtagnorm,0);

};

#endif

#ifdef flavtagnorm_cxx
void flavtagnorm::Init(TTree *tree)
{
