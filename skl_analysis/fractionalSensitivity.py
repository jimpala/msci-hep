...
def main():
    ...
    for variant in ['signal', 'background']:
        ...
        for fraction in sample_fracs:
            ...
            bdt_k1 = AdaBoostClassifier(DecisionTreeClassifier(max_depth=2, min_samples_leaf=0.1),
                                        learning_rate=0.15,
                                        algorithm="SAMME",
                                        n_estimators=200
                                        )
        
            bdt_k2 = AdaBoostClassifier(DecisionTreeClassifier(max_depth=2, min_samples_leaf=0.1),
                                        learning_rate=0.15,
                                        algorithm="SAMME",
                                        n_estimators=200
                                        )
