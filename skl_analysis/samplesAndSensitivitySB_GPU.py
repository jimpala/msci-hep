...
def main():
    ...
    df_k1_2jet = pd.read_csv('/home/jpyne/CSV/VHbb_data_2jet_even.csv', index_col=0)
    df_k1_3jet = pd.read_csv('/home/jpyne/CSV/VHbb_data_3jet_even.csv', index_col=0)
    df_k2_2jet = pd.read_csv('/home/jpyne/CSV/VHbb_data_2jet_odd.csv', index_col=0)
    df_k2_3jet = pd.read_csv('/home/jpyne/CSV/VHbb_data_3jet_odd.csv', index_col=0)
