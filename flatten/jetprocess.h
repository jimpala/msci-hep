...
// Tue Jul 12 15:06:49 2016 by ROOT version 6.06/04
// from TTree jetprocess/bTagAntiKt4EMTopoJets
...
// ROOT 5 doesn't seem to auto-load std namespace.
using namespace std;
...
#ifdef jetprocess_cxx
jetprocess::jetprocess(TTree *tree) : fChain(0) 
{
...
Long64_t jetprocess::LoadTree(Long64_t entry)
{
...
void jetprocess::Init(TTree *tree)
{
...
void jetprocess::Show(Long64_t entry)
{
...
Int_t jetprocess::Cut(Long64_t entry)
{
