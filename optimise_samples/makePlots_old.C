...
void makePlots() {
  ...
  config.setOutputPath("./plotsBDTv1/");
  ...
  */ 
  ...
  config.addVariable(Config::BDTOutput, "mva_v3", "BDT signal", -1, 1, 40);
  config.addVariable(Config::BDTOutput, "mvaWlvH125", "BDT signal", -1, 1, 40);
  config.addVariable(Config::BDTOutput, "mvaVZ", "BDT VZ", -1, 1, 40);
  config.addVariable(Config::BDTOutput, "mvaWbb", "BDT Wbb", -1, 1, 40);
  ...
  */
  ...
  // }
   ...
   config.addSensitivityPlot( "mva_v3", "mva_v3", "2tag2jet_150ptv_SR", "trafoD");
   config.addSensitivityPlot( "mva_v3", "mva_v3", "2tag3jet_150ptv_SR", "trafoD");
