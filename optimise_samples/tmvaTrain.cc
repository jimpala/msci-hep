...
// Create ouput file, factory object and open the input file
  ...
  bool useTruthAll = (std::atoi(argv[5])==1);
  bool MVADiboson = (std::atoi(argv[6])==1);
  bool massWindowCut = (std::atoi(argv[7])==1);
...
//  TString kFold = (i==0) ? "0of2" : "1of2";
  ...
  TString version = "_v6";
  if(useAlternative) kFold+="_SystTTbar";
...
//  factory->BookMethod(TMVA::Types::kBDT, "BDT_AdaBoost_v2","IgnoreNegWeightsInTraining:!H:!V:NTrees=200:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.15:SeparationType=GiniIndex:nCuts=100:MinNodeSize="+min+":PruneMethod=NoPruning");
  factory->BookMethod(TMVA::Types::kBDT, "BDT_AdaBoost_v6","IgnoreNegWeightsInTraining:!H:!V:NTrees=200:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.15:SeparationType=GiniIndex:nCuts=100::MinNodeSize=5%:PruneMethod=NoPruning");
