...
void makePlots() {
  ...
  config.setInputFile("hyper_kInvert_out");
  ...
  config.setOutputPath("./plots_hyper_kInvert/");
  ...
  */
  // cut based regions  
    config.addRegion(  "2tag2jet_150ptv_100_150mbb_SR", "2tag2jet_150ptv_SR",
     "2 tags, 2 jets, p_{T}^{V} >= 150 GeV, m_{bb} cut", "2 tags, 2 jets");
  config.addRegion(  "2tag3jet_150ptv_100_150mbb_SR", "2tag3jet_150ptv_SR",
     "2 tags, 3 jets, p_{T}^{V} >= 150 GeV, m_{bb} cut", "2 tags, 3 jets");
  config.addRegion(  "2tag2jet_150ptv__0_100mbb_SR", "2tag2jet_150ptv_SR",
     "2 tags, 2 jets, p_{T}^{V} >= 150 GeV, m_{bb} lower cut", "2 tags, 2 jets");
  config.addRegion(  "2tag3jet_150ptv__0_100mbb_SR", "2tag3jet_150ptv_SR",
     "2 tags, 3 jets, p_{T}^{V} >= 150 GeV, m_{bb} lower cut", "2 tags, 3 jets");
  config.addRegion(  "2tag2jet_150ptv__150mbb_SR", "2tag2jet_150ptv_SR",
     "2 tags, 2 jets, p_{T}^{V} >= 150 GeV, m_{bb} higher cut", "2 tags, 2 jets");
  config.addRegion(  "2tag3jet_150ptv__150mbb_SR", "2tag3jet_150ptv_SR",
