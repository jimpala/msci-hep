...
//  bool useSherpa221 = (std::atoi(argv[4])==1);
  ...
  bool massWindowCut = true;
  bool useWeights = (std::atoi(argv[5])==1);
...
//  factory->BookMethod(TMVA::Types::kBDT, "BDT_AdaBoost_v7","IgnoreNegWeightsInTraining:!H:!V:NTrees=200:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.15:SeparationType=GiniIndex:nCuts=100::MinNodeSize=1%:PruneMethod=NoPruning");
  factory->BookMethod(TMVA::Types::kBDT, "BDT_AdaBoost_v9","IgnoreNegWeightsInTraining:!H:!V:NTrees=400:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=0.15:SeparationType=GiniIndex:nCuts=100::MinNodeSize="+min_v8+"%:PruneMethod=NoPruning");
