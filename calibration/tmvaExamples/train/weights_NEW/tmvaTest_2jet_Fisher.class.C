...
{
   fFisher0 = 0.0757476011391;
   fFisherCoefficients.push_back( -0.14425014961 );
   fFisherCoefficients.push_back( 2.66272209433 );
   fFisherCoefficients.push_back( 3.58667818303 );
   fFisherCoefficients.push_back( -0.0552675844659 );
   fFisherCoefficients.push_back( 0.0113110370881 );
   fFisherCoefficients.push_back( -3.27658239464 );
