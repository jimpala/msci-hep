...
#ifndef tag_metric_no_sv0_h
#define tag_metric_no_sv0_h
...
public :
   ...
   tag_metric_no_sv0(TTree *tree=0);
   virtual ~tag_metric_no_sv0();
...
#ifdef tag_metric_no_sv0_cxx
tag_metric_no_sv0::tag_metric_no_sv0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      cout << "tag_metric_no_sv0 needs to take a tree argument, champ. Terminating program.\n";
      exit(1);
   }
...
tag_metric_no_sv0::~tag_metric_no_sv0()
{
   if (!fChain) return;
   //delete fChain->GetCurrentFile();
}

Int_t tag_metric_no_sv0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tag_metric_no_sv0::LoadTree(Long64_t entry)
{
...
void tag_metric_no_sv0::Init(TTree *tree)
{
...
Bool_t tag_metric_no_sv0::Notify()
{
...
void tag_metric_no_sv0::Show(Long64_t entry)
{
...
Int_t tag_metric_no_sv0::Cut(Long64_t entry)
{
...
#endif // #ifdef tag_metric_no_sv0_cxx
